"""
Django settings for heladosuvcrud project.
...
SECRET_KEY = 'django-insecure-3)$$d8$k5)4un5zs7x9$m$0kd1u&7k8+&ph#8jekey0om17zw)'
...
ROOT_URLCONF = 'heladosuvcrud.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'helados', 'frontend', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'heladosuvcrud.wsgi.application'
